...
export const MENU_GROUPS: { title: string; items: MenuItem[] }[] = [
  {
    title: '매일',
    items: [
      { id: 'collect', label: '수집', ready: true, icon: icon('M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 10l5 5 5-5M12 15V3') },
    ],
  },
  {
    title: '상품',
  ...
  },
  {
    title: '로켓',
    items: [
      { id: 'rocket-stock', label: '로켓재고', ready: true, icon: icon('M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4') },
      { id: 'rocket-sales', label: '판매량', ready: true, icon: icon('M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z') },
      { id: 'rocket-in', label: '입고', ready: true, icon: icon('M12 4v12m0 0l-4-4m4 4l4-4M4 20h16') },
    ],
  },
  {
    title: '사무실',
