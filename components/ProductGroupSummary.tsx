...
const ProductGroupSummary: React.FC<ProductGroupSummaryProps> = ({
  ...
  return (
    <div className="w-full flex flex-wrap items-center gap-x-3 gap-y-2 px-4 py-2 bg-white rounded-xl border border-gray-200 shadow-lg hover:border-gray-300 transition-colors duration-150">
      <button
        type="button"
        onClick={onToggle}
        className="flex items-center gap-3 min-w-0 flex-shrink-0 basis-[220px] text-left"
      ...
      <div className="flex flex-wrap items-center gap-2 flex-1 min-w-[260px]">
        <div className="relative flex items-center justify-center flex-shrink-0 w-9 h-9" title="URL (클릭해서 붙여넣기 · 아이콘 클릭 시 새 탭에서 열기)">
          <input
            type="text"
            value={lead.url}
