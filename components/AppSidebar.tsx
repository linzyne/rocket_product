...
export const MENU_GROUPS: { title: string; items: MenuItem[] }[] = [
  ...
  },
  {
    title: '발주',
    items: [
      { id: 'coupang-order', label: '쿠팡발주확인', ready: false, icon: icon('M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4') },
      { id: 'cn-order', label: '한중발주', ready: false, icon: icon('M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z') },
    ],
  },
  {
    title: '물류',
    items: [
      { id: 'import-in', label: '수입입고', ready: false, icon: icon('M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4') },
      ...
      { id: 'warehouse-in', label: '물류창고입고', ready: false, icon: icon('M3 21V9l9-6 9 6v12M7 21v-8h10v8M7 17h10') },
    ],
  },
  {
    title: '판매',
    items: [
      { id: 'sales', label: '판매량/재고', ready: false, icon: icon('M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z') },
    ],
  },
];
